# Primärer Takt (250 MHz / 4 ns)
create_clock -period 4.000 -name sys_clk [get_ports CLK]
set_clock_uncertainty 0.050 [get_clocks clk]

# Da es sich um ein synchrones Design handelt, setzen wir
# typische Input/Output Delays (ca. 20% der Periodendauer)
...
# Optimierung der FSM und der Arithmetik (Barrel Shifter)
